    ...
    <div class="products-content">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <a href="{{route('admin.addproduct')}}" class="btn btn-sm btn-success pull-right"><i class="tim-icons icon-simple-add"></i> New Product</a>
                </div>
            </div>
            <!-- Filter top row -->
            <div class="row">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                    @if($updateMode)
                        @include('livewire.admin.edit-product-component')
                    @endif
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <a href="{{route('admin.editproduct',['product_slug'=>$product->product_slug])}}" title="edit product" class="btn btn-success btn-sm btn-icon">
