                 ...
                 <div class="col-md-12 col-sm-12">
                     <nav class="breadcrumb">
                         <ul>
                            ...
                            <li class="nav-item">
                            <a href="{{ route('category.products', ['category_slug'=>$parentcategory->slug]) }}">{{$parentcategory->name}}</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('category.products', ['category_slug'=>$prod_category->slug]) }}">{{$category_name}}</a>
                            </li>
                            <li class="nav-item">
                                <a href="permal-link">{{$product->product_name}}</a>
                            </li>
                         </ul>
                     </nav>
                 </div>
