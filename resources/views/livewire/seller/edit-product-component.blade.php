                ...
                <div class="card p-3">
                    ...
                    <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label"><strong>Product Slug</strong></label>
                                        <div class="">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class=" control-label"><strong> SKU (Product Code)</strong></label>
                                        <div class="">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                <label class="control-label"><strong>Short Description(Highlights*)</strong></label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class=" control-label"><strong>Weight</strong></label>
                                        <div class="">
                            ...
                            <div class="stock_options">
                                <label><strong>Product Available :</strong></label><br>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class=" control-label no-padding-right" for="brand_id"><strong>Choose Brand (Optional)</strong></label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                    <label for="categoryInput">Choose Condition</label>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 mb-2">
                                    <div class="form-group">
                                        <label for="fileInput"><i class="tim-icons icon-image-02"></i><strong>Product Image: </strong> </label>
                                        @if($newimage)
                            ...
                            <div class="col-md-6 mb-2">
                                    <div class="form-group">
                                        <label for="fileInput"><i class="tim-icons icon-image-02"></i><strong>Product Video: </strong> </label>
