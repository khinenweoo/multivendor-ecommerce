...
<div id="body-content" class="body-content">
          ...
          <div class="hero-slide">
            ...
            <div class="slide-content text-left col-md-4 col-sm-12">
                <span class="slide-text">
                 ...
                 <h1 class="slide-title mb-3">Create & Sell<br>
                   <span style="text-transform:uppercase;">Custom Products Online</span>
                   <br/> <h5 class="sale-text">Only on <span>Proud of Myanmar</span></h5>
                </h1>  
    ...
    <section>
        ...
        <li class="nav-item"><a class="nav-link" href="#" data-toggle="tab">Featured</a></li>
        </ul>
                                    ...
                                    <div class="single-product product-card">
                                        <div class="product-image">
                                            ...
                                            <div class="prod-action">
                                                ...
                                                <a href="#"  wire:click.prevent="addtocart({{$nproduct->product_id}},'{{$nproduct->product_name}}',{{$nproduct->price}})" class="add-to-cart action-btn" aria-label="Add To Cart"><i class="fa fa-shopping-bag"></i></a>
                                    ...
                                    @foreach ($trending_products as $tproduct)
                                        ...
                                        <div class="single-product product-card">
                                            ...
                                            <div class="product-content">
                                                ...
                                                <a href="#"  wire:click.prevent="addtocart({{$tproduct->product_id}},'{{$tproduct->product_name}}',{{$tproduct->price}})" class="add-to-cart action-btn" aria-label="Add To Cart"><i class="fa fa-shopping-bag"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- single product end -->
    ...
    <aside id="sidebar-cart" class="cart">
        <main>
          ...
          <a class="view-cart-button" href="{{route('product.cart')}}"> View Cart</a>
            @auth
            <a class="checkout-button" href="{{ route('user.checkout') }}">Checkout</a>
            @else
