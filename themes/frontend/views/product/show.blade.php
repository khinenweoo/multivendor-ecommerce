                 ...
                 <div class="col-md-12 col-sm-12">
                     <nav class="breadcrumb">
                         <ul>
                             ...
                             <li class="nav-item">
                                 <a href="permal-link">Pillows & Blankets</a>
                             </li>
                             <li class="nav-item">
                                 <a href="permal-link">Pillows</a>
                             </li>
                         </ul>
                     </nav>
                 </div>
    ...
    <section class="product-detail">
        ...
        <div class="row">
            ...
            <div class="main-image-column" id="main-image">
                ...
                <div class="product-image-selector"><!-- Product Carousel -->
            ...
            <div class="col-md-5 col-sm-12 col-xs-12 product-info-col">
                ...
                <div class="row">
                    ...
                    <div class="quantity-wrapper">
                        ...
                        <input min="1" class="form-control form-control-sm" placeholder="Quantity" id="quantity" name="quantity" type="number" value="1">
                    </div> 
                    </div>
                </div>
                ...
                <div class="prod-add-to-cart">
                    ...
                    <div class="add">
                        <button class="btn btn-primary add-cart-btn" data-button-action="add-to-cart" type="submit" disabled="">
            ...
            <div class="col-md-3 col-sm-12">
                <div class="fixed-right-block">
                    <div class="action-inner">
                        <div class="ship-area">
                            <ul>
                                <!-- <li class="ship-info"> 
                                    <span class="sub-item-left text-left">
                                        Deliver to
                                        <span class="method"><strong>United Kingdom</strong> </span>
                                    </span>
                ...
                <div class="company-card seller-card">
                        ...
                        <div class="card-logo">
                            <a href=""><i class="icon-diamond"></i> Gold Seller</a>
                        </div>
                        <div class="company-name-container">
                            <a href="" class="company-name">
                                Bingfan Technology Co., Ltd
                            </a>
                        </div>
                        <div class="join-year">
                                ...
                                <div class="tab-pane active" id="details">
                                    ...
                                    <div class="product-tabs">
                                        ...
                                        <div class="tab-content ">
                                            ...
                                            <div class="tab-pane" id="prod_details">
                                                <p>
